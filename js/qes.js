...
function preSolveEqnA() {
  ...
  if ((input1.value > 99) || (input1.value < -99)) {
    checkLimitA.innerHTML = "a პარამეტრის მნიშნველობა არ შეიძლება იყოს 99 ზე მეტი ან -99 ნაკლები";
...
function preSolveEqnB() {
  ...
  if ((input2.value > 99) || (input2.value < -99)) {
    checkLimitB.innerHTML = "b პარამეტრის მნიშნველობა არ შეიძლება იყოს 99 ზე მეტი ან -99 ნაკლები";
...
function preSolveEqnC() {
  ...
  if ((input3.value > 999) || (input3.value < -999)) {
    checkLimitC.innerHTML = "c პარამეტრის მნიშნველობა არ შეიძლება იყოს 999 ზე მეტი ან -999 ნაკლები";
